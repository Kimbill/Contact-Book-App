...
namespace ContactBook.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpGet("search")]
        public async Task<IActionResult> Search(PagingParameterModel parameterModel, string searchItem = "")
        {
            var result = await _userService.Search(parameterModel, searchItem);
            try
            {
                return Ok(result);
            }
